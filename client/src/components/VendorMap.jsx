...
const VendorMap = ({ products = [] }) => {
  ...
  // Group products by supplier and create map data
  const suppliersMap = products.reduce((acc, product) => {
    ...
    if (!acc[supplierName]) {
      acc[supplierName] = {
        ...
        speed: product.supplier.speed,
        reliability: product.supplier.reliability,
        products: [],
        // Generate random location within ~5km of vendor
        coordinates: [
