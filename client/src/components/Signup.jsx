            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className={`relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none transition-all duration-200 ${
                  ...
                  <div className="flex items-center">
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      role === 'vendor' ? 'border-blue-500' : 'border-gray-300'
                    }`}>
                      {role === 'vendor' && (
                ...
                <label className={`relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none transition-all duration-200 ${
                  ...
                  <div className="flex items-center">
                    <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                      role === 'supplier' ? 'border-blue-500' : 'border-gray-300'
                    }`}>
                      {role === 'supplier' && (
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                      )}
                    ...
                    <div className="ml-3">
                      <span className={`block text-sm font-medium ${
                        role === 'supplier' ? 'text-blue-900' : 'text-gray-900'
                      }`}>
                        Sell Products
                      </span>
                      <span className={`block text-xs ${
                        role === 'supplier' ? 'text-blue-700' : 'text-gray-500'
                      }`}>
                        I'm a supplier
                      </span>
                    </div>
