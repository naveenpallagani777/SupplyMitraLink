...
const SupplierProfile = () => {
  ...
  const getStatusText = (status) => {
    switch (status) {
      case "order-received":
        return t("supplierProfile.order.status.received");
      case "packed":
        ...
        <main className="max-w-3xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <p className="text-gray-700 mb-2">
              {t("supplierProfile.businessType")}:{" "}
              {supplierProfile.businessType}
            </p>
            <p className="text-gray-700 mb-2">
              {t("supplierProfile.farmSize")}: {supplierProfile.farmSize}
            </p>
            <p className="text-gray-700 mb-2">
              {t("supplierProfile.specializations")}:{" "}
              {supplierProfile.specializations.join(", ")}
            </p>
            <p className="text-gray-700 mb-2">
              {t("supplierProfile.certifications")}:{" "}
              {supplierProfile.certifications.join(", ")}
            </p>
            <p className="text-gray-700 mb-2">
              {t("supplierProfile.rating")}: {supplierProfile.rating} ⭐
            </p>
          </div>
        </main>
      </div>
                ...
                <div className="p-4 md:p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 md:ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">
                          {t("supplierProfile.totalEarnings")}
                        </dt>
                        <dd className="text-xl md:text-2xl font-semibold text-gray-900">
                          ₹{supplierProfile.totalEarnings.toLocaleString()}
                        </dd>
                      </dl>
                    </div>
                  </div>
                ...
                <div className="p-4 md:p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 md:ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-500 truncate">
                          {t("supplierProfile.avgOrderValue")}
                        </dt>
                        <dd className="text-xl md:text-2xl font-semibold text-gray-900">
                          ₹{supplierProfile.averageOrderValue}
                        </dd>
                      </dl>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
                        {t("supplierProfile.farmSize")}
                      </label>
                      <p className="text-sm text-gray-900 mt-1">
                        {supplierProfile.farmSize}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
                        {t("supplierProfile.registrationDate")}
                      </label>
                      <p className="text-sm text-gray-900 mt-1">
                        {supplierProfile.registrationDate}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700">
              ...
              <div key={order.id} className="bg-white rounded-lg shadow p-6">
                ...
                <div className="flex space-x-3">
                  ...
                  {order.status === "packed" && (
                    <button
                      onClick={() =>
                        handleOrderAction(order.id, "start-transit")
                      }
                  ...
                  {order.status === "in-transit" && (
                    <button
                      onClick={() =>
                        handleOrderAction(order.id, "out-delivery")
                      }
                  ...
                  {order.status === "out-for-delivery" && (
                    <button
                      onClick={() =>
                        handleOrderAction(order.id, "mark-delivered")
                      }
                      className="bg-green-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-green-700 transition-colors duration-200"
                    >
