      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <nav className="flex space-x-8 overflow-x-auto">
            ...
            >
              {t("supplierDashboard.localOrders")} (
              {
                orders.filter((o) => parseInt(o.id.split("-")[1]) % 3 === 0)
                  .length
              }
              )
            </button>
            ...
            >
              {t("supplierDashboard.confirmedOrders")} (
            ...
            >
              {t("supplierDashboard.otherOrders")} (
              {
                orders.filter((o) => parseInt(o.id.split("-")[1]) % 3 !== 0)
                  .length
              }
